...
function leaderboard_update() {
    ...
    $.ajax({
        url: "http://dhanak19-001-site4.htempurl.com/api/astro/leader",
        //type:"GET",
        //dataType:'json',
...
function submit() {
    ...
    if (ans.value.length == 0)
        ...
        $.ajax({
            type: 'GET',
            dataType: 'json',
            url: "http://dhanak19-001-site4.htempurl.com/api/astro/answer/" + obj.DId + "/" + ans.value,
...
function getquestion_v2() {
    ...
    if (!(cdata == "")) {
        ...
        $.ajax({
            type: "GET",
            url: "http://dhanak19-001-site4.htempurl.com/api/astro/ques/" + obj.DId,
            beforeSend:function(){console.log('starting getQues Request');},
            success: function (result) {
                if(result.stage>19){
                    alert("Congratulations.....be prepered for the next LEVEL.");
                }
                else{
                    console.log(result);
