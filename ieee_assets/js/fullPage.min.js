var defaults = {
  ...
  , utils = {
    setVendor: function(t, e, i) {
        t && (t.style[e.charAt(0).toLowerCase() + e.slice(1)] = i,
        t.style["webkit" + e] = i,
        t.style["moz" + e] = i,
        t.style["ms" + e] = i,
        t.style["o" + e] = i)
  ...
  , FullPage = function(t, e) {
    ...
    this.settings = Object.assign({}, defaults, e),
...
FullPage.prototype.makeActive = function(t) {
    for (var e = document.querySelectorAll(".slide-navigation li a"), i = 0; i < this.sections.length; i++)
        this.sections[i].classList.remove("is-active"),
        e[i].classList.remove("is-active");
    this.sections[t].classList.add("is-active"),
    e[t].classList.add("is-active")
}
,
FullPage.prototype.move = function(t) {
    var e = this;
    "function" == typeof e.settings.onLeave && e.settings.onLeave(this.index),
    utils.setVendor(this.el, "Transform", "translate3d(0, " + t * -100 + "%, 0)"),
    utils.setVendor(this.el, "Transition", "transform " + this.settings.animationDuration + "ms");
    var i = function() {
        "function" == typeof e.settings.afterLoad && e.settings.afterLoad(e.index)
    };
    console.log("current value of t is",t);
    this.el.addEventListener("transitionend", i),
    this.index = t,
    this.makeActive(t)
}
,
...
FullPage.prototype.enableTouch = function(t) {
    ...
    t.addEventListener("touchend", function(t) {
        ...
        s = n - i,
        o - Math.abs(e.lastAnimation) < e.settings.animationDuration || (s < 0 && Math.abs(s) > e.settings.touchLimit ? e.moveDown() : s > 0 && Math.abs(s) > e.settings.touchLimit && e.moveUp(),
        e.lastAnimation = o)
    })
}
,
